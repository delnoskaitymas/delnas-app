...
- Sudėtingi/knyginiai žodžiai: "manifestuoja", "transformacija", "potencialas" (kaip terminas), "orientyras", "dinamika", "konsensusas" (→ "bendras sutarimas"), "delegauti/delegavimas" (→ "perduoti kitiems"), "struktūra" kaip abstraktus terminas, "faktorius" (→ "veiksnys") — pakeisk paprastesniais
...
- DRAUDŽIAMA: sudėtingi, knyginiai, moksliniai ar oficialūs žodžiai (pvz. "manifestuoja", "transformacija", "potencialas" kaip terminas, "orientyras", "dinamika", "konsensusas" — vietoj jo "bendras sutarimas", "delegauti/delegavimas" — vietoj jo "perduoti kitiems", "faktorius" — vietoj jo "veiksnys")
